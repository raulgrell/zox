...
pub const Chunk = struct {
    ...
    pub fn disassembleInstruction(chunk: *const Chunk, offset: usize) usize {
        ...
        switch (instruction) {
            ...
            .Swap => return simpleInstruction("Swap", offset),
            .Dup => return simpleInstruction("Dup", offset),
            .GetLocal => return byteInstruction("GetLocal", chunk, offset),
            .GetLocal_0 => return simpleInstruction("GetLocal_0", offset),
            .GetLocal_1 => return simpleInstruction("GetLocal_1", offset),
            .GetLocal_2 => return simpleInstruction("GetLocal_2", offset),
            .SetLocal => return byteInstruction("SetLocal", chunk, offset),
            .SetLocal_0 => return simpleInstruction("SetLocal_0", offset),
            .SetLocal_1 => return simpleInstruction("SetLocal_1", offset),
            .SetLocal_2 => return simpleInstruction("SetLocal_2", offset),
            ...
            .Modulus => return simpleInstruction("Divide", offset),
            .Remainder => return simpleInstruction("Divide", offset),
            ...
            .Call_0 => return simpleInstruction("Call_0", offset),
            .Call_1 => return simpleInstruction("Call_1", offset),
            .Call_2 => return simpleInstruction("Call_2", offset),
            .Class => return constantInstruction("Class", chunk, offset),
            ...
            else => return unknownInstruction(instruction, offset),
        }
    }
